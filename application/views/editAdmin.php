 ...
 <section>
 	<form action="<?= base_url('index.php/admin/editAdmin/').$admin[0]->id?>" method="POST">
 	<div class="row">
 		<div class="col-8 ml-5">
 			...
 			<div class="form-group row">
 				...
 				<div class="col-6">
 					<input type="text" name="nama" class="form-control" placeholder="nama admin" value="<?= $admin[0]->nama ?>">
 				</div>
 			</div>
			 <div class="form-group row">
 			...
 			<div class="form-group row">
 				...
 				<div class="col-6">
 					<input type="text" name="umur" value="<?= $admin[0]->umur ?>" class="form-control">
 				</div>
 			</div>
 			<!--row 3-->
 			<div class="form-group row">
 				...
 				<div class="col-6">
 					<input type="text" name="alamat" id=alamat class="form-control" value="<?= $admin[0]->alamat ?>">
 				</div>
 			</div>
 			<!--row 4-->
 			<div class="form-group row">
 				...
 				<div class="col-6">
 					<input type="email" name="email" id="email" class="form-control" value="<?= $admin[0]->email ?>">
 				</div>
 			</div>
 			<!--row 5-->
 			<div class="form-group row">
 				...
 				<div class="col-6">
 					<input type="text" name="hp" id="nohp" class="form-control" value="<?= $admin[0]->hp ?>">
 				</div>
 			</div>
